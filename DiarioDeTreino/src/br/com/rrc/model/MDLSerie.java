...
public class MDLSerie {
	...
	private int fk_Int_Codigo_Exercicio_Grupo_Divisao;
	...
	public int getFk_Int_Codigo_Exercicio_Grupo_Divisao() {
		return fk_Int_Codigo_Exercicio_Grupo_Divisao;
	}
	public void setFk_Int_Codigo_Exercicio_Grupo_Divisao(int fk_Int_Codigo_Exercicio_Grupo_Divisao) {
		this.fk_Int_Codigo_Exercicio_Grupo_Divisao = fk_Int_Codigo_Exercicio_Grupo_Divisao;
	}
	...
	public MDLSerie(int pk_Int_Codigo_Serie,
					int fk_Int_Codigo_Exercicio_Grupo_Divisao, 
					double flt_Carga,
					int int_Repeticoes,
					boolean bit_Completou, 
					Date dtt_Inicio,
					Date dtt_Fim) {
		super();
		this.pk_Int_Codigo_Serie = pk_Int_Codigo_Serie;
